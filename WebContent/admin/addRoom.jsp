					    ...
					    <div class="card-body">
					        <form class="form" action="config/connection.jsp" method="post" >
					            <div class="md-form mt-5">
					                ...
					                <label for="room_name" class="font-weight-light">Room No :</label>
					            </div>
					            <div class="md-form mt-5">
					                <i class="fas fa-columns prefix grey-text"></i>
					                <input type="text" name="room_capacity"  class="form-control">
					                <label for="room_capacity" class="font-weight-light">Room Capacity</label>
					            </div>
					            <div class="text-center py-4 ">
					                <button class="btn btn-cyan w-50" name="room_form" type="submit">Add Room</button>
					            </div>
					        </form>
